...
const Sidebar = ({ open }) => {
  return (
    <>
      {/* Only render Sidebar if open is true */}
      {open && (
        <>
          {/* component */}
          <div className="mt-5 relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
