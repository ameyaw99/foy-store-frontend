  ...
  return (
    <Container maxWidth="md">
      ...
      <Typography paragraph>
        ...
        according to our Refund Policy: [LINK TO REFUND POLICY] We have made
      ...
      <Typography variant="h6" gutterBottom>
        SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFO{" "}
      </Typography>
      <Typography paragraph>
        ...
        you as needed. For more details, please review our Refund Policy: [LINK
        TO REFUND POLICY]
      </Typography>{" "}
      <Typography variant="h6" gutterBottom>
      ...
      <Typography paragraph>
        ...
        shall FocusOnYourself, our directors, officers, employees, affiliates,
      ...
      <Typography paragraph>
        You agree to indemnify, defend and hold harmless FocusOnYourself and our
