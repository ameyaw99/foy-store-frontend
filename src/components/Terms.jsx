    ...
    <div className="bg-neutral-950 text-white -mt-5 -mb-7">
      <Container maxWidth="md">
        ...
        <Typography paragraph>
          ...
          review our Refund Policy: [LINK TO REFUND POLICY]
        </Typography>{" "}
        <Typography variant="h6" gutterBottom>
        ...
        <Typography paragraph>
          ...
          non-infringement. In no case shall FocusOnYourself, our directors,
        ...
        <Typography paragraph>
          You agree to indemnify, defend and hold harmless FocusOnYourself and
